...
const myImages = [
  {
    ...
    description: "Ballsack Storck!!! Lorizzle ma nizzle dolor crackalackin yo, we gonna chung adipiscing elit. Rizzle sapien velizzle, dope volutpizzle, suscipizzle bling bling, tellivizzle vizzle, funky fresh. Pellentesque eget tortizzle. Sizzle erizzle."
  },
  {
    title: 'Amboseli Flamingos',
    src: 'img/amboseli-flamingos.jpg',
    description: "Flamingos!! Lorizzle ma nizzle dolor crackalackin yo, we gonna chung adipiscing elit. Rizzle sapien velizzle, dope volutpizzle, suscipizzle bling bling, tellivizzle vizzle, funky fresh. Pellentesque eget tortizzle. Sizzle erizzle."
  },
  {
    title: 'Amboseli Flamingos 2',
    src: 'img/amboseli-flamingos2.jpg',
    description: "More flamingos!! Lorizzle ma nizzle dolor crackalackin yo, we gonna chung adipiscing elit. Rizzle sapien velizzle, dope volutpizzle, suscipizzle bling bling, tellivizzle vizzle, funky fresh. Pellentesque eget tortizzle. Sizzle erizzle."
  },
  {
    title: 'Giraffe Couple',
    src: 'img/girraffe-couple.jpg',
    description: "A giraffe couple!! Lorizzle ma nizzle dolor crackalackin yo, we gonna chung adipiscing elit. Rizzle sapien velizzle, dope volutpizzle, suscipizzle bling bling, tellivizzle vizzle, funky fresh. Pellentesque eget tortizzle. Sizzle erizzle."
  },
  {
    title: 'Male Ostrich',
    src: 'img/male-ostrich.jpg',
    description: "A male ostrich!! Lorizzle ma nizzle dolor crackalackin yo, we gonna chung adipiscing elit. Rizzle sapien velizzle, dope volutpizzle, suscipizzle bling bling, tellivizzle vizzle, funky fresh. Pellentesque eget tortizzle. Sizzle erizzle."
  },
  {
    title: 'Savannah with Zebras',
    src: 'img/savannah.jpg',
    description: "Zebras!! Lorizzle ma nizzle dolor crackalackin yo, we gonna chung adipiscing elit. Rizzle sapien velizzle, dope volutpizzle, suscipizzle bling bling, tellivizzle vizzle, funky fresh. Pellentesque eget tortizzle. Sizzle erizzle."
  },
]
